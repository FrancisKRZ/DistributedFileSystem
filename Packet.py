...
class Packet:
	...
	# self
	def getPutFileInfo(self):
		if "fname" in self.packet and "fsize" in self.packet and "content" in self.packet:
			return self.packet["fname"], self.packet["fsize"] , self.packet["content"]
